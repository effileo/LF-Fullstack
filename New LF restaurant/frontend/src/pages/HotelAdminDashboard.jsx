...
const HotelAdminDashboard = () => {
    ...
    const getFilteredProducts = () => {
        if (activeSection === 'specials') return products.filter(p => p.isSpecial);
    ...
    return (
        <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
            ...
            <header className="hero" style={{ height: '25vh', alignItems: 'center' }}>
                <div className="container">
                    <h1>{hotelDetails?.name || 'Hotel Admin'}</h1>
            ...
            <main className="container" style={{ padding: '2rem 0', flex: 1 }}>
                ...
                {/* PRODUCTS VIEWS (Services, Menu, Rooms, Specials) */}
                {['services', 'menu', 'rooms', 'specials'].includes(activeSection) && (
                    <div>
                        ...
                        {showProductForm && (
                            <div className="card animate-fade-in" style={{ marginBottom: '2rem', border: '1px solid var(--primary)' }}>
                                <h3 style={{ marginBottom: '1rem' }}>Add New {activeSection === 'specials' ? 'Special Item' : activeSection.slice(0, -1)}</h3>
